...
public class Player implements Serializable {
    ...
    public boolean handleTurn(Computer computer, int x, int y) {
        CharactersBoard computerBoard = computer.getBoard();
        switch (computerBoard.getCharactersBoard()[y][x]) {
            case 'o':
                computerBoard.getCharactersBoard()[y][x] = 'm';
                this.incTurns();
                return true;
            case 's':
                computerBoard.getCharactersBoard()[y][x] = 'h';
                this.incTurns();
